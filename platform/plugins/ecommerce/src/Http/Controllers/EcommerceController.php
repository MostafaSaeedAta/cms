...
{
    public function __construct(protected StoreLocatorInterface $storeLocatorRepository)
    {
    }

    public function getSettings(CurrencyInterface $currencyRepository)
    {
        ...
        $currencies = $currencyRepository->getAllCurrencies()->toArray();
